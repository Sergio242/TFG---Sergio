...
public class WalkNpc2 extends Enemy {
	...
	public WalkNpc2(float x, float y, Stage s, GameScreen nivel) {
		super(x, y, s, nivel);

		frente = loadFullAnimation("player/frontMainCharacter3.png", 1, 4, 0.2f, true);
		espalda = loadFullAnimation("player/backMainCharacter3.png", 1, 4, 0.2f, true);
		drcha = loadFullAnimation("player/rightMainCharacter3.png", 1, 4, 0.2f, true);
		izqda = loadFullAnimation("player/leftMainCharacter3.png", 1, 4, 0.2f, true);

		frenteIdle = loadFullAnimation("player/frontMainCharacterIdle3.png", 1, 4, 0.2f, true);
		espaldaIdle = loadFullAnimation("player/backMainCharacterIdle3.png", 1, 4, 0.2f, true);
		drchaIdle = loadFullAnimation("player/rightMainCharacterIdle3.png", 1, 4, 0.2f, true);
		izqdaIdle = loadFullAnimation("player/leftMainCharacterIdle3.png", 1, 4, 0.2f, true);
