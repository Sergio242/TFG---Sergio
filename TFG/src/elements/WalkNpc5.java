...
public class WalkNpc5 extends Enemy {
	...
	public WalkNpc5(float x, float y, Stage s, GameScreen nivel) {
		super(x, y, s, nivel);

		frente = loadFullAnimation("player/frontMainCharacterW2.png", 1, 4, 0.2f, true);
		espalda = loadFullAnimation("player/backMainCharacterW2.png", 1, 4, 0.2f, true);
		drcha = loadFullAnimation("player/rightMainCharacterW2.png", 1, 4, 0.2f, true);
		izqda = loadFullAnimation("player/leftMainCharacterW2.png", 1, 4, 0.2f, true);

		frenteIdle = loadFullAnimation("player/frontMainCharacterIdleW2.png", 1, 4, 0.2f, true);
		espaldaIdle = loadFullAnimation("player/backMainCharacterIdleW2.png", 1, 4, 0.2f, true);
		drchaIdle = loadFullAnimation("player/rightMainCharacterIdleW2.png", 1, 4, 0.2f, true);
		izqdaIdle = loadFullAnimation("player/leftMainCharacterIdleW2.png", 1, 4, 0.2f, true);
